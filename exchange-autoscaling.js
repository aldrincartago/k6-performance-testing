...
export const options = {
  ...
  scenarios: {
    Exchange_API: {
      ...
      gracefulStop: '30s',
      stages: [
        { target: 2, duration: '1m' }, //warm-up
        { target: 10, duration: '10m' }, //ramp-up
        { target: 10, duration: '10m' }, //sustained load
      ],
      preAllocatedVUs: 20,
      startRate: 1,
      timeUnit: '1s',
...
export default function() {
  ...
  for (let i = 0; i < 1; i++) {
    ...
    const protectedRes = http.post(protectedExchangeUrl, protectedExchangePayload, protectedExchangeParams);
    check(protectedRes, {
